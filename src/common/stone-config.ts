...
export class StoneConfig {
    ...
    draw(deltaTime: number) {
        ...
        this.context.shadowBlur = 10; // Blur level of the shadow
        this.context.shadowOffsetX = 5; // Horizontal shadow offset
        this.context.shadowOffsetY = 5; // Vertical shadow offset

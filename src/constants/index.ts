...
export const MAP_ICON = "./assets/images/mapIcon.png";
export const CANCEL_BUTTON = "./assets/images/close_btn.png";
export const CLOSE_BUTTON = "./assets/images/map_btn.png";
export const NEXT_BUTTON = "./assets/images/next_btn.png";
export const NO_BUTTON = "./assets/images/close_btn.png";
export const PAUSE_BUTTON = "./assets/images/pause_v01.png";
export const RETRY_BUTTON = "./assets/images/retry_btn.png";
export const YES_BUTTON = "./assets/images/confirm_btn.png";
export const SURE_AND_PAUSE_POPUP = "./assets/images/popup_bg_v01.png";
export const PLAY_BUTTON = "./assets/images/Play_button.png";
export const PROMPT_TEXT_BG = "./assets/images/promptTextBg.png";
export const PROMPT_PLAY_BUTTON = "./assets/images/promptPlayButton.png";
...
export const TIMER_EMPTY = "./assets/images/timer_empty.png";
export const ROTATING_CLOCK = "./assets/images/timer.png";
export const TIMER_FULL = "./assets/images/timer_full.png";
export const TUTORIAL_HAND = "./assets/images/tutorial_hand.png";
export const MAP_ICON_SPECIAL =
  "./assets/images/map_icon_monster_level_v01.png";
export const MAP_LOCK = "./assets/images/mapLock.png";
export const STAR = "./assets/images/star.png";
export const BACK_BUTTON = "./assets/images/back_btn.png";
export const WIN_BG = "./assets/images/WIN_screen_bg.webp";
export const PIN_STAR_1 = "./assets/images/pinStar1.png";
export const PIN_STAR_2 = "./assets/images/pinStar2.png";
export const PIN_STAR_3 = "./assets/images/pinStar3.png";

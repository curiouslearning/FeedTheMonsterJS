...
export const MAP_ICON = "./assets/images/mapIcon.webp";
export const CANCEL_BUTTON = "./assets/images/close_btn.webp";
export const CLOSE_BUTTON = "./assets/images/map_btn.webp";
export const NEXT_BUTTON = "./assets/images/next_btn.webp";
export const NO_BUTTON = "./assets/images/close_btn.webp";
export const PAUSE_BUTTON = "./assets/images/pause_v01.webp";
export const RETRY_BUTTON = "./assets/images/retry_btn.webp";
export const YES_BUTTON = "./assets/images/confirm_btn.webp";
export const SURE_AND_PAUSE_POPUP = "./assets/images/popup_bg_v01.webp";
...
export const STAR = "./assets/images/star.webp";
export const BACK_BUTTON = "./assets/images/back_btn.webp";

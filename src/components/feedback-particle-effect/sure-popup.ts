...
// import YesButton from "../buttons/yes-button"; // Import the YesButton class
...
export default class AreYouSurePopUp {
    ...
    // public yesButton: YesButton; // Add YesButton property
    public imagesLoaded: boolean = false;
    public pop_up_image: HTMLImageElement;
    public yesCallback: Function; // Define yesCallback property
    public noCallback: Function; // Define noCallback property
    ...
    dispose = () => {
        console.log("we are in the sure dispose>>>>")
        document
            .getElementById("canvas")
